module.exports = {
  ...
  react: function(msg) {
    ...
    if (msg.includes("match")) { emoji.push("🔥") }
    ...
    if (msg.includes("homo")) { emoji.push("🌈") }
    ...
    if (msg.includes("glasses")) { emoji.push("👓") }
    if (msg.includes("smart")) { emoji.push("👓") }
    if (msg.includes("see")) { emoji.push("👓") }
    ...
    if (msg.includes("back in the day")) { emoji.push("📆") }
    if (msg.includes("today")) { emoji.push("📅") }
    if (msg.includes("tomorrow")) { emoji.push("📆") }
    if (msg.includes("yesterday")) { emoji.push("📆") }
    if (msg.includes("cuss")) { emoji.push("🗡") }
    if (msg.includes("curse")) { emoji.push("🗡") }
    if (msg.includes("neck")) { emoji.push("🦒") }
    if (msg.includes("slow")) { emoji.push("🐢") }
    if (msg.includes("parab")) { emoji.push("🐂") }
    if (msg.includes("parab")) { emoji.push("🐃") }
    if (msg.includes("yorrick")) { emoji.push("💀") }
    if (msg.includes("yorick")) { emoji.push("💀") }
    if (msg.includes("word")) { emoji.push("🐦") }

    // Animals
    if (msg.includes("emu")) { emoji.push("🐦") }
    if (msg.includes("emo")) { emoji.push("🐦") }
    if (msg.includes("bird")) { emoji.push("🐦") }
    ...
    if (msg.includes("slither")) { emoji.push("🐍") }
    if (msg.includes("worm")) { emoji.push("🐛") }
    if (msg.includes("parasite")) { emoji.push("🐛") }
    ...
    if (msg.includes("pair")) { emoji.push("🍐") }
    ...
    if (msg.includes("mobile")) { emoji.push("🏎") }
    if (msg.includes("truck")) { emoji.push("🚚") }
    if (msg.includes("deliver")) { emoji.push("🚚") }
    if (msg.includes("load")) { emoji.push("🚛") }
    ...
    if ((msg.includes("time")) && (!(msg.includes("timer")))) { emoji.push("🕰") }
    ...
    if (msg.includes("shitter")) { emoji.push("🚽") }
    if (msg.includes("crapper")) { emoji.push("🚽") }
    if (msg.includes("commode")) { emoji.push("🚽") }
    ...
    if (msg.includes("electric")) { emoji.push("⚡") }
    ...
    if (msg.includes("well")) { emoji.push("💧") }
    ...
    if (msg.includes("favorite")) { emoji.push("♥") }
    ...
    if (msg.includes("invest")) { emoji.push("⛳") }
    ...
    if (msg.includes("hard")) { emoji.push("💅") }
    if (msg.includes("difficult")) { emoji.push("💅") }
    if (msg.includes("challeng")) { emoji.push("💅") }
    if (msg.includes("business")) { emoji.push("🐸☕") }
    ...
    if (msg.includes("wrench")) { emoji.push("🔧") }
    if (msg.includes("fix")) { emoji.push("🔧") }
    ...
    if ((msg.includes("pen")) && (!(msg.includes("pencil")))) { emoji.push("🖋") }
    if (msg.includes("pencil")) { emoji.push("🖋") }
    if (msg.includes("draw")) { emoji.push("✏") }
    ...
    if (msg.includes("texas")) { emoji.push("🤠") }
    if (msg.includes("houston")) { emoji.push("🤠") }
    if (msg.includes("dallas")) { emoji.push("🤠") }
    if (msg.includes("austin")) { emoji.push("🤠") }
    if (msg.includes("wild west")) { emoji.push("🤠") }
    ...
    if (msg.includes("youtube")) { emoji.push("📺") }
    ...
    // Music
    if (msg.includes("music")) { emoji.push("🎼") }
    if (msg.includes("piano")) { emoji.push("🎼") }
    if (msg.includes("sing")) { emoji.push("🎵") }
    if (msg.includes("dance")) { emoji.push("💃") }
    if (msg.includes("disco")) { emoji.push("🕺") }
    if (msg.includes("song")) { emoji.push("🎶") }
    if (msg.includes("album")) { emoji.push("📻") }
    if (msg.includes("pandora")) { emoji.push("📻") }
    if (msg.includes("spotify")) { emoji.push("📻") }
    ...
    if (msg.includes("rock")) { emoji.push("🎸") }
